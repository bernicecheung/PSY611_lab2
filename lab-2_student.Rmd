...
You can download the rmd file [here](https://uopsych.github.io/psy611/labs/lab-2.Rmd). 
...
#df <- import(".data/world_happiness_2015.csv")
```
...
df <- import(here("data", "world_happiness_2015.csv"))
```
...
4. Use bracket notation to extract the relationship between `GDP` and `happiness` using each of these methods. Report the result using in-line r code.
